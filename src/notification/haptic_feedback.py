...
# At the top of src/notification/haptic_feedback.py
import sys
import logging

# Try to import real bluetooth, fall back to mock if not available
try:
    import bluetooth
except ImportError:
    logging.warning("Real bluetooth module not available, using mock")
